    ...
    static void run() {
        ...
        StatusReportDataAccessInterface reports = new StatusReportDataAccessInterface() {
            ...
            public List<StatusReport> getRecentForWashroom(String id, LocalDateTime since) {
                return List.of(new StatusReport(id, null, 2, 5, MaintenanceIssue.NONE, LocalDateTime.now()));
            }
        ...
        final RecommendWashroomOutputData[] out = new RecommendWashroomOutputData[1];
        RecommendWashroomOutputBoundary presenter = new RecommendWashroomOutputBoundary() {
