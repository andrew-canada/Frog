...
public record Building(String code, String name, double latitude,
    ...
    public String getBuildingCode() { return code; }
    public String getBuildingNameShort() { return name; }
    public String getBuildingNameLong() { return name; }
    public String getControlInfo() { return ""; }
