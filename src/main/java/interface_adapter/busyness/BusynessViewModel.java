...
public final class BusynessViewModel extends ViewModel<BusynessViewModel.State>{
    public BusynessViewModel(){super(new State(List.of(),""));}
    public record State(List<BusynessStatsOutputData.HourBucket> buckets,String note){public State{buckets=List.copyOf(buckets);}}
}
