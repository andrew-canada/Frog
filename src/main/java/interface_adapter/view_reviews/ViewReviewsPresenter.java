...
public final class ViewReviewsPresenter implements ViewReviewsOutputBoundary {
    ...
    public ViewReviewsPresenter(ReviewsViewModel model) { this.model=model; }
    @Override public void present(ViewReviewsOutputData d) {
    ...
    @Override public void presentError(String message) {
        ReviewsViewModel.State s=model.getState();
